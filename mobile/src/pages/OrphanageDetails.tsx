...
export default function OrphanageDetails() {
  ...
  function handleOpenGoogleMapsRoutes() {
    ...
    // orphanage?.latitude : o ? verifica se o orfanato existe antes de usar a propriedade latirude
  }
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.imagesContainer}>
        ...
        {/* scrollview serve para que o usuario possa fazer o scroll (default: vertical), por isso ctem a propriedade horizontal ali
         Alem disso, a prop pageEnable calcula o tamanho da imagem e sempretermina o scroll do usuario de acordo com a posição da imagem */}
